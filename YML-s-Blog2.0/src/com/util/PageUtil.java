...
public class PageUtil {
	 ...
	 * @return
	 */
	public static String getPageTool(HttpServletRequest request, int total, int page, int size){
		...
		buf.append("<h2 style='display:inline-block; font-size: 14px;'>[").append(page).append("/").append(pages).append("]</h2>\n");
		buf.append("<h2 style='display:inline-block; font-size: 14px;'>[").append(total).append("]</h2>\n");
		if (page >= pages) {
